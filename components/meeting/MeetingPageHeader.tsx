        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-0.5 text-sm text-[#3F5363]">
              Phase A.5 prepares the real Microsoft Teams path without faking success.
            </p>
            <p className="mt-3 max-w-2xl text-sm text-[#314555]">
              Relay will only report validated milestones for Yassin&apos;s Relay.
              Any dependency that still needs Azure, tenant, or meeting-side
              confirmation stays visible as a blocker.
            </p>
          </div>
